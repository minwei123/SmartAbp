    ...
    public class SmartAbpWebModule : AbpModule
    {
        ...
        private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
        {
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<SmartAbpDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}SmartAbp.Domain.Shared"));
                    options.FileSets.ReplaceEmbeddedByPhysical<SmartAbpDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}SmartAbp.Domain"));
                    options.FileSets.ReplaceEmbeddedByPhysical<SmartAbpApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}SmartAbp.Application.Contracts"));
                    options.FileSets.ReplaceEmbeddedByPhysical<SmartAbpApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}SmartAbp.Application"));
