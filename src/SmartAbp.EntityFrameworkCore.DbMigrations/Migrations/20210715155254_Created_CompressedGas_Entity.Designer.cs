...
namespace SmartAbp.Migrations
{
    ...
    [Migration("20210715155254_Created_CompressedGas_Entity")]
    partial class Created_CompressedGas_Entity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartAbp.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SmartAbp.Stations.TransportRobot", b =>
                {
                    b.HasBaseType("SmartAbp.Stations.Robot");

                    b.Property<string>("Name")
                        .HasColumnType("nvarchar(max)");

                    b.ToTable("AppTransportRobots");
                });
            ...
            modelBuilder.Entity("SmartAbp.Stations.TransportRobot", b =>
                {
                    b.HasOne("SmartAbp.Stations.Robot", null)
                        .WithOne()
                        .HasForeignKey("SmartAbp.Stations.TransportRobot", "Id")
